...
export const config: DevDashConfig = {
	github_access_token: import.meta.env.VITE_GITHUB_PERSONAL_ACCESS_TOKEN as string, //import.meta.env.VITE_GITHUB_PERSONAL_ACCESS_TOKEN//////process.env.REACT_APP_GITHUB_PERSONAL_ACCESS_TOKEN
	widgets: [
		{
